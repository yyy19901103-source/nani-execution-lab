  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '1.5rem 1rem 4rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '0.75rem' }}>
        ...
        <NavCard href={`${base}/ai-tools/pmp-study/glossary`} icon="📖" label="用語集" desc="817語 (公式691+独自126)" />
        <NavCard href={`${base}/ai-tools/pmp-study/materials`} icon="🔐" label="教材原文 (要パス)" desc="PMI公式17ファイル/187MB" highlight />
